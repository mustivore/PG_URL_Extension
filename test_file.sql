...
INSERT INTO test_url(id, link) VALUES (15, make_url('https://www.ulb.ac.be'));
...
INSERT INTO test_url(id, link) VALUES (19, make_url_prot_host_port_file(
													text_to_cstring(get_protocol('https://user:password@www.example.com:42/forum/questions/?tag=networking&order=newest#top')),
													get_host('https://user:password@www.example.com:42/forum/questions/?tag=networking&order=newest#top'),
													--get_port('https://user:password@www.example.com:42/forum/questions/?tag=networking&order=newest#top'),
													443,
													get_file('https://user:password@www.example.com:42/forum/questions/?tag=networking&order=newest#top')
													));
